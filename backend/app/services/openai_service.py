...
5. TERMINOLOGI DEWASA AYU:
   - Berdasarkan database 'baik_buruk_hari' atau 'InformasiPakakalan', gunakan terminologi 'Ayu' untuk kondisi/kegiatan baik, 'Ala-Ayu' untuk netral/biasa, dan 'Ala' untuk kondisi buruk yang sebaiknya dihindari.
